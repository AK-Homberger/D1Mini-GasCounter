...
#endif
```
If you have configured MQTT with username an password on your MQTT server, then you have to provide username and pawsword in the client.connect function call. Please change line: 
```
