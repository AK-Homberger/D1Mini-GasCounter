...
<body style="font-family: verdana,sans-serif" BGCOLOR="#819FF7">
  <table>
    <tr><td style="text-align:right;">Time:</td><td style="color:white;"><span id='time'></span> </td></tr>
    <tr><td style="text-align:right;">Count:</td><td style="color:white;"><span id='stand'></span> m³ </td></tr>
    <tr><td style="text-align:right;">Today:</td><td style="color:white;"><span id='heute'></span> m³ </td></tr>
    <tr><td style="text-align:right;">Yesterday:</td><td style="color:white;"><span id='gestern'></span> m³ </td></tr>
    <tr><td style="text-align:right;">Current:</td><td style="color:white;"><span id='m3h_akt'></span> m³/h </td></tr>
    <tr><td style="text-align:right;">Hour:</td><td style="color:white;"><span id='m3h'></span> m³/h </td></tr>
    <tr><td style="text-align:right;">Day:</td><td style="color:white;"><span id='tag'></span> m³/d </td></tr>
  </table>
  <br>
  <hr>
  <p>
  <input type="button" class="button" id='set' value=' Set ' onclick="button_clickedSend()"> 
